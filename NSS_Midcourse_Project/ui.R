               ...
               tabPanel("", 
                        ...
                        sidebarLayout(
                          ...
                          sidebarPanel(
                            ...
                            selectizeInput("updateSong2",
                                           "Select a Second Song:",
                                           choices = NULL),
                            htmlOutput("frame"),
                            style = "width: 485px",
                          ),
                                        ...
                                        tabPanel("",
                                                 ...
                                                 fluidRow(column(3,
                                                                 ...
                                                                 numericInput("setstarttime", 
                                                                              "Start Time of Sample 1:", 
                                                                              value = 36,
                                                                              min = 0,
                                                                              max = 100,
                                                                              step = 1),
                                                                 br(),
                                                                 numericInput("setstarttime2", 
                                                                              "Start Time of Sample 2:", 
                                                                              value = 36,
                                                                              min = 0,
                                                                              max = 100,
                                                                              step = 1),
                                                                 ...
                                                                 sliderTextInput("duration",
                                                                                 "Set Duration of Samples:",
                                                                                 choices = c(1:5)),
                                                                 br(),
                                                                 awesomeRadio(
                                                                   inputId = "spectro_sample",
                                                                   label = "Choose Spectrogram Sample:", 
                                                                   choices = c("Sample 1", "Sample 2"),
                                                                   selected = "Sample 1"
                                                                 ),
                                                                 style = 'border-right: 1px solid #d1d1d1; height: 400px;'),
                                                          column(9,
